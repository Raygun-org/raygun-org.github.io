    ...
    <div class="container animate__animated animate__fadeDown">
        <div class="row py-5 justify-content-center align-items-center">
            ...
            <div class="col-md-8 col-sm-12 ps-4">
                ...
                <h3 class="fst-italic text-end" data-aos="flip-up" data-aos-delay="400" data-aos-anchor-position="top-bottom"><a href="/contact/">Let's work together <i class="fa fa-arrow-right-long" aria-hidden="true" data-aos="fade-right" data-aos-delay="600"></i></a></h3>
            </div>
        </div>
    </div>
</div>
