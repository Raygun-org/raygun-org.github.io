...
<div class="container-fluid statement pb-5">
    <div class="container">
            ...
            <div class="col-md-12 col-lg-6">
                <div id="carouselWebsites" class="carousel carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <a href="/websites/liz-mccarthy/" alt="Liz McCarthy Case Study"><img src="/assets/img/portfolio/liz-mccarthy/liz-mccarthy-mbp.png" class="d-block w-100" alt="Liz McCarthy Website"></a>
                        </div>
                        <div class="carousel-item">
                            <a href="/websites/red-letter-clay/" alt="Red Letter Clay Case Study"><img src="/assets/img/portfolio/rlc/redletterclay-mbp.png" class="d-block w-100" alt="Red Letter Clay Website"></a>
                        </div>
                    </div>
        ...
        <div class="row my-5 py-5 align-items-center">
            <div class="col-md-12 col-lg-6">
                <h2 class="mt-5 header-spacing text-uppercase text-center"><a href="/portfolio/photography/" alt="Photography Portfolio" class="text-white text-decoration-none">Digital Photography</a></h2>
        ...
        <div class="row my-5 py-5">
            <div class="col-md-12 col-lg-6">
                <a href="/marketing/11-degrees-daiquiri/" alt="11 Degrees Daiquiri Case Study"><img src="/assets/img/portfolio/11-degrees/11-degrees-nav.png" class="img-fluid" data-aos="fade-in" alt="11 Degrees Daiquiri Case Study"></a>
            </div>
            <div class="col-md-12 col-lg-6">
                <h2 class="mt-5 header-spacing text-uppercase text-center"><a href="/portfolio/marketing/" alt="Digital Marketing Portfolio" class="text-white text-decoration-none">Digital Marketing<br> <span class="fw-light">&</span> Content Management</a></h2>
...
<div class="container-fluid pb-5">
    <div class="d-lg-flex text-center">
        <div class="col-lg-4 col-sm-12 px-md-5 px-sm-0">
            ...
            <h3 class="mt-5 header-spacing"><a href="/websites/higher-grounds/" alt="Higher Grounds SEO Score" class="text-white text-decoration-none">Search Engine Optimization (SEO)</a></h3>
        ...
        <div class="col-lg-4 col-sm-12 px-md-5 px-sm-0">
            ...
            <h3 class="mt-5 header-spacing"><a href="/portfolio/video/" alt="Video Editing Portfolio" class="text-white text-decoration-none">Video Editing</a></h3>
            <h4 class="fw-light type-3 mb-5 eyebrow text-uppercase text-center">Mood, Meaning & Message</h4>
            <p class="alt">I have edited <a href="/video/the-other-guantanamo/" alt="The Other Guantanamo">documentary film</a> and trailers, digitally archived physical DV tape footage, and also work with legacy formats like DVD authoring.</p>
        </div>
        <div class="col-lg-4 col-sm-12 px-md-5 ps-xs-0">
            ...
            <h3 class="mt-5 header-spacing">Restoration<br><span class="fw-normal">&</span> <a href="/portfolio/cms/" alt="CMS Development Portfolio" class="text-white text-decoration-none">CMS Transitioning</a></h3>
