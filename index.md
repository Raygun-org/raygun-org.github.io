...
<div class="container-fluid statement pb-5">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-12 col-lg-6">
                <h2 class="my-5 header-spacing text-uppercase"><a href="/portfolio/website-design/" alt="Website Design Portfolio" class="text-white">Website Design</a> + <a href="/portfolio/website-development/" alt="Website Development Portfolio" class="text-white">Development</a></h2>
                <h3 class="fw-semibold type-3 my-4">Don't settle for a website that's just "good enough"</h3>
        ...
        <div class="row my-5 py-5 align-items-center">
            <div class="col-md-12 col-lg-6">
                <h2 class="my-5 header-spacing"><a href="/portfolio/photography/" alt="Digital Photography Portfolio" class="text-white text-uppercase">Photography</a></h2>
                <h3 class="my-4 fw-semibold type-3">Bringing Brands to Life & Making Products Shine</h3>
        ...
        <div class="row my-5 py-5">
            ...
            <div class="col-md-12 col-lg-6">
                <h2 class="my-5 header-spacing text-uppercase"><a href="/portfolio/marketing/" alt="Digital Photography Portfolio" class="text-white">Digital Marketing + Content Management</a></h2>
...
<div class="container-fluid pb-5">
    <div class="row text-center my-5">
        <div class="col-12"><h2 class="text-uppercase">Additional Services</h2></div>
    </div>
